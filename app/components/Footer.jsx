                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    <div className="space-y-4">
                        <div className="text-2xl font-bold text-white tracking-tight">
                            <Link href="/">
                                <img src="/paragon-white-logo.png" alt="" className="w-39" />
                            </Link>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li>Paragon Building, 2/F, McArthur Highway, Clark Freeport Area, Philippines 2009</li> 
                            <li>info@paragonoutsourcing.com</li>
                            <li>+1 877 913 1020 (US)</li>
                        </ul>
                    </div>
                </div>

                <div className="border-t border-slate-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-xs">
                    <p>© {new Date().getFullYear()} Paragon. All rights reserved.</p>
