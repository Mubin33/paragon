...
const InsightsPage = () => {
    const posts = [
        ...
        },
        {
            ...
            date: "Jan 05, 2026",
            image: "/mailer.png",
            desc: "A deep dive into how Paragon manages high-concurrency systems for 10M+ users across continents."
        },
        {
            ...
            <section className="py-24 bg-white border-b border-slate-100">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed font-medium">
                        Exploring the frontier of AI, Cloud, and Engineering. Stay updated with the latest research from Paragon.
                    </p>
                </div>
            </section>
